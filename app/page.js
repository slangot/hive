        ...
        {(initWindow.width && initWindow.height) && <>
          ...
          <div className="relative">
            <Image
              ...
              src='../public/images/hive-2-abbeal.png'
              alt='hive with logo'
              width={300}
              height={300}
            />
            <Image
              ...
              src='../public/images/hive-layout-1.png'
              alt='hive'
              width={300}
              height={300}
            />
          ...
          <Image className="fixed z-[60] top-[130px] object-contain"
            ...
            width={100}
            height={100}
            src='../public/images/bee-1-sm-2.png'
            alt='bee'
            id='bee-img'
          />
          ...
          <Image className="fixed hidden z-30"
            ref={staticLogos1}
            src='../public/images/logos-x3-1.png'
            width={60}
            height={60}
          ...
          <Image className="fixed hidden z-[29]"
            ref={staticLogos2}
            src='../public/images/logos-x3-2.png'
            width={60}
            height={60}
          ...
          <Image className="fixed hidden z-[28]"
            ref={staticLogos3}
            src='../public/images/logos-x3-3.png'
            width={60}
            height={60}
          ...
          <Image className="fixed hidden z-[40]"
            ref={staticBoard1}
            src='../public/images/board-skills-1.png'
            width={200}
            height={0}
          ...
          <div className="flex items-center justify-center w-full h-full">
            <a href='mailto:langot.sylvain.contact@gmail.com'>
              <button className="fixed hidden z-50 px-3 bg-white font-bold text-orange-500 bg-transparent w-[120px] h-[120px] rounded-lg" style={{ backgroundColor: 'transparent', backgroundImage: 'url(../public/images/hive-btn-1-min.png)', backgroundSize: 'cover', animation: 'beehiveAnimation 5s linear infinite' }} ref={buttonRef}>Me contacter</button>
            </a>
          </div>
          ...
          <div
            ...
            style={{ backgroundImage: `url('../public/images/grass-flower-1.png')` }}
          />
